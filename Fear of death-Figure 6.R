...
####################################################
###Fig. 6 compare with and without decay of all three control frequencies under intermediate initial fear
...
tiff(paste("Figure 6-MultiControl_Decay vs. nodecay_threesita_", "thres =",thres, "tau = ", tau, "CD =", CD_period, "K =", K_M, ".tiff"), width = 10, height = 10, units='in',res=600)
...
legend(100, 8, legend =  c("Cont_Period", " = 1", " = 6", " = 365"), bty = "n", cex = 1.25, col = c("white","red", "purple", "blue"), lwd = c(2, 2, 2), lty = c(1, 1, 1, 1))
